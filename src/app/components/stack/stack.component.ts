...
export class StackComponent {
  ...
  public logosInfo : StackLogo[] = [
    ...
    { src: '/assets/svg/Java-logo.svg', alt: 'Icono de Java', color: 'linear-gradient(180deg, rgba(237,139,0,1) 0%, rgba(0,115,150,1) 56%)'},
    { src: '/assets/svg/Vue-js-logo.svg', alt: 'Icono de Vue', color: 'linear-gradient(180deg, rgba(52,73,94,1) 0%, rgba(65,184,131,1) 91%)'},
